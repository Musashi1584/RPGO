class RPGO_UIArmory_PromotionHeroColumn extends UIArmory_PromotionHeroColumn;
...
function OnAbilityInfoClicked(UIButton Button)
{
	...
	local RPGO_UIArmory_PromotionHero PromotionScreen;
	local int idx;

	PromotionScreen = RPGO_UIArmory_PromotionHero(Screen);
...
{
	return RPGO_UIArmory_PromotionHero(Screen).AttemptScroll(Up);
}
