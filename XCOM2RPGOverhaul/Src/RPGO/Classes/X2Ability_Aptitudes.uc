...
static function X2AbilityTemplate Guttersnipe()
{
	...
	FlankEffect.AddToHitModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("GUTTERSNIPE_CRIT"), eHit_Crit);
	FlankEffect.AddShredModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("GUTTERSNIPE_SHRED_CV"), eHit_Success, 'conventional');
	FlankEffect.AddShredModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("GUTTERSNIPE_SHRED_MG"), eHit_Success, 'magnetic');
	FlankEffect.AddShredModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("GUTTERSNIPE_SHRED_BM"), eHit_Success, 'beam');
	...
	Effect.AddPersistentStatChange(eStat_Mobility, class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("GUTTERSNIPE_MOBILITY"));
...
static function X2AbilityTemplate Warden()
{
	...
	ReactionFire.ReactionModifier = class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("WARDEN_REACTION_AIM");
...
static function X2AbilityTemplate Activist()
{
	...
	Effect.AddPersistentStatChange(eStat_DetectionRadius, class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("ACTIVIST_DETECTION_MOD"));
	...
	Effect = new class 'X2Effect_PersistentStatChange';
	Effect.BuildPersistentEffect(1, true, false, false);
	Effect.AddPersistentStatChange(eStat_DetectionRadius, class'RPGO_Helper'.static.GetAbilityConfig().GetConfigFloatValue("ACTIVIST_DETECTION_MOD_CIVS"));
...
static function X2AbilityTemplate NobleScion()
{
	...
	Effect.DuplicateResponse = eDupe_Ignore;
	Effect.AddPercentDamageModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("WAR_HERO_DAMAGE_BONUS"));
...
static function X2AbilityTemplate LoneWolf()
{
	...
	AllyEffect.AddToHitModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("LONE_WARRIOR_CRIT"), eHit_Crit);
	
	Condition = new class 'X2Condition_NearestAlly';
	Condition.bBeyond = true;
	Condition.TileDistance = class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("LONE_WARRIOR_RADIUS");
	...
	Effect.BuildPersistentEffect(1, true, false, false);
	Effect.AddPersistentStatChange(eStat_DetectionModifier, class'RPGO_Helper'.static.GetAbilityConfig().GetConfigFloatValue("LONE_WARRIOR_DETECTION_MOD"));
	Effect.AddPersistentStatChange(eStat_Mobility, class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("LONE_WARRIOR_MOBILITY"));
...
static function X2AbilityTemplate OldGuard()
{
	...
	Effect.AddDamageModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("OLD_GUARD_DAMAGE_BONUS"), eHit_Success, 'conventional');
	Effect.AddDamageModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("OLD_GUARD_CRIT_DAMAGE_BONUS"), eHit_Crit, 'conventional');
	Effect.AddArmorPiercingModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("OLD_GUARD_ARMOR_PIERCE"), eHit_Success, 'conventional');
...
static function X2AbilityTemplate Militia()
{
	...
	RangeEffect.RangeMultiplier=class'RPGO_Helper'.static.GetAbilityConfig().GetConfigFloatValue("MILITIA_RANGE_MULTIPLIER");
	...
	Effect = new class'X2Effect_PersistentStatChange';
	Effect.AddPersistentStatChange(eStat_Offense, class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("MILITIA_AIM"));
	Effect.AddPersistentStatChange(eStat_SightRadius, class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("MILITIA_SIGHT_RADIUS"));
...
static function X2AbilityTemplate Informant()
{
	...
	ADVEffect.AddToHitModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("INFORMANT_CRIT"), eHit_Crit);
	...
	Effect.BuildPersistentEffect(1, true, false, false);
	Effect.AddPersistentStatChange(eStat_Hacking, class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("INFORMANT_HACK"));
	Effect.AddPersistentStatChange(eStat_Mobility, class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("INFORMANT_MOBILITY"));
	Condition = new class'X2Condition_MissionData';
	Condition.bSupply = true;
...
static function X2AbilityTemplate Guerilla()
{
	...
	FlankEffect = new class'XMBEffect_ConditionalBonus';
	FlankEffect.AddToHitModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("GUERILLA_CRIT"), eHit_Crit);
	FlankEffect.AddArmorPiercingModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("GUERILLA_PIERCE_CV"), eHit_Success, 'conventional');
	FlankEffect.AddArmorPiercingModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("GUERILLA_PIERCE_MG"), eHit_Success, 'magnetic');
	FlankEffect.AddArmorPiercingModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("GUERILLA_PIERCE_BM"), eHit_Success, 'beam');
	...
	Effect = new class 'X2Effect_PersistentStatChange';
	Effect.BuildPersistentEffect(1, true, false, false);
	Effect.AddPersistentStatChange(eStat_Defense, class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("GUERILLA_DEFENSE"));
	Condition = new class'X2Condition_MissionData';
...
static function X2AbilityTemplate Survivor()
{
	...
	Condition.AddCheckStat(eStat_HP, class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("SURVIVOR_DAMAGE_THRESHOLD"), eCheck_LessThan,,, true);

	Effect = new class'XMBEffect_ConditionalBonus';
	Effect.AddPercentDamageModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("SURVIVOR_DAMAGE_BONUS"));
...
static function X2AbilityTemplate Outcast()
{
	...
	Effect = new class'X2Effect_PersistentStatChange';
	Effect.AddPersistentStatChange(eStat_FlankingAimBonus, class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("OUTCAST_FLANKING_AIM"));
	...
	Effect.BuildPersistentEffect(1, true, false, false);
	Effect.AddPersistentStatChange(eStat_Dodge, class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("OUTCAST_DODGE"));
	Condition = new class'X2Condition_MissionData';
	Condition.bSupply = true;
	Condition.AllowedPlots.AddItem("Wilderness");
	Condition.AllowedPlots.AddItem("SmallTown");
...
static function X2AbilityTemplate Revolutionary()
{
	...
	Effect = new class'XMBEffect_ConditionalBonus';
	Effect.AddDamageModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("REVOLUTIONARY_DAMAGE_CV"), eHit_Success, 'conventional');
	Effect.AddDamageModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("REVOLUTIONARY_DAMAGE_MG"), eHit_Success, 'magnetic');
	Effect.AddDamageModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("REVOLUTIONARY_DAMAGE_BM"), eHit_Success, 'beam');
...
static function X2AbilityTemplate SysAdmin()
{
	...
	Effect = new class'XMBEffect_ConditionalBonus';
	Effect.AddDamageModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("SYSADMIN_DAMAGE_CV"), eHit_Success, 'conventional');
	Effect.AddDamageModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("SYSADMIN_DAMAGE_MG"), eHit_Success, 'magnetic');
	Effect.AddDamageModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("SYSADMIN_DAMAGE_BM"), eHit_Success, 'beam');
	Effect.AddToHitAsTargetModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("SYSADMIN_ROBOT_DEFENSE"), eHit_Success);
	...
	StatEffect.AddPersistentStatChange(eStat_Hacking, class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("SYSADMIN_HACKING"));
...
static function X2AbilityTemplate Pacifist()
{
	...
	MobEffect.AddPersistentStatChange(eStat_Defense, class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("PACIFIST_DEFENSE"));
...
static function X2AbilityTemplate Pacifist_Dmg()
{
	...
	Effect = new class'XMBEffect_ConditionalBonus';
	Effect.AddPercentDamageModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("PACIFIST_DAMAGE_MOD"));
	Effect.BuildPersistentEffect(1, true, false, false);
...
static function X2AbilityTemplate Anarchist()
{
	...
	PyroEffect.BaseCharges = class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("ANARCHIST_CHARGES");
	...
	Effect = new class'XMBEffect_ConditionalBonus';
	Effect.AddToHitModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("ANARCHIST_CRIT"), eHit_Crit);
	Effect.ScaleValue = Value;
	Effect.ScaleMax = class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("ANARCHIST_CRIT_MAX");
...
static function X2AbilityTemplate Vanguard()
{
	...
	Effect.DodgeMod = class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("VANGUARD_DODGE");
	Effect.HitMod = class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("VANGUARD_AIM");
	Effect.CritMod = class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("VANGUARD_CRIT");
	Effect.TileRange = class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("VANGUARD_RANGE");
	Effect.bWithin = true;
...
static function X2AbilityTemplate Rebel()
{
	...
	Effect = new class'XMBEffect_ConditionalBonus';
	Effect.AddDamageModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("REBEL_DAMAGE_CV"), eHit_Success, 'conventional');
	Effect.AddDamageModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("REBEL_DAMAGE_MG"), eHit_Success, 'magnetic');
	Effect.AddDamageModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("REBEL_DAMAGE_BM"), eHit_Success, 'beam');
...
static function X2AbilityTemplate Insurgent()
{
	...
	Effect.DuplicateResponse = eDupe_Ignore;
	Effect.AddArmorPiercingModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("INSURGENT_ARMOR_PIERCE"));
	Effect.AbilityTargetConditions.AddItem(default.GameplayVisibilityCondition);
...
static function X2AbilityTemplate Xenophobe()
{
	...
	Effect = new class'XMBEffect_ConditionalBonus';
	Effect.AddDamageModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("XENOPHOBE_DAMAGE_CV"), eHit_Success, 'conventional');
	Effect.AddDamageModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("XENOPHOBE_DAMAGE_MG"), eHit_Success, 'magnetic');
	Effect.AddDamageModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("XENOPHOBE_DAMAGE_BM"), eHit_Success, 'beam');
...
static function X2AbilityTemplate FortuneHunter()
{
	...
	Effect.DamageMod = class'RPGO_Helper'.static.GetAbilityConfig().GetConfigFloatValue("FORTUNE_HUNTER_DAMAGE_MOD");
...
static function X2AbilityTemplate Renegade()
{
	...
	Effect.CritMod = class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("RENEGADE_CRIT");
	Effect.DamageReduction = class'RPGO_Helper'.static.GetAbilityConfig().GetConfigFloatValue("RENEGADE_DAMAGE_REDUCTION");
...
static function X2AbilityTemplate Irregular()
{
	...
	DamageTaken.PercentDamageMod = class'RPGO_Helper'.static.GetAbilityConfig().GetConfigFloatValue("IRREGULAR_DAMAGE_MALUS");
...
static function X2AbilityTemplate Pioneer()
{
	...
	Effect.AddDamageModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("PIONEER_DAMAGE_LASER"), eHit_Success, 'laser');
	Effect.AddDamageModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("PIONEER_DAMAGE_MG"), eHit_Success, 'magnetic');
	Effect.AddDamageModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("PIONEER_DAMAGE_COIL"), eHit_Success, 'coil');
	Effect.AddDamageModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("PIONEER_DAMAGE_BM"), eHit_Success, 'beam');
...
static function X2AbilityTemplate Professional()
{
	...
	ReactionFire.AddPercentDamageModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("PROFESSIONAL_DAMAGE_BONUS"), eHit_Success);
...
static function X2AbilityTemplate Tactician()
{
	...
	// Create a conditional bonus
	Effect = new class'XMBEffect_ConditionalBonus';
	Effect.AddDamageModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("TACTICIAN_DAMAGE_CV"), eHit_Miss, 'conventional');
	Effect.AddDamageModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("TACTICIAN_DAMAGE_MG"), eHit_Miss, 'magnetic');
	Effect.AddDamageModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("TACTICIAN_DAMAGE_BM"), eHit_Miss, 'beam');
...
static function X2AbilityTemplate Mercenary()
{
	...
	Effect.bIntel = false;
	Effect.Cap = class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("MERCENARY_CRIT_CAP");
	Effect.Factor = class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("MERCENARY_CRIT_SUPPLY_FACTOR");
...
static function X2AbilityTemplate Saboteur()
{
	...
	Effect.bIntel = true;
	Effect.Cap = class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("SABOTEUR_CRIT_CAP");
	Effect.Factor = class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("SABOTEUR_CRIT_INTEL_FACTOR");
...
static function X2AbilityTemplate Scrapper()
{
	...
	Effect = new class'XMBEffect_ConditionalBonus';
	Effect.AddToHitModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("SCRAPPER_CRIT"), eHit_Crit);
...
static function X2AbilityTemplate Heretic()
{
	...
	Effect = new class'XMBEffect_ConditionalBonus';
	Effect.AddPercentDamageModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("HERETIC_DAMAGE_BONUS"));
	Effect.AbilityTargetConditions.AddItem(default.MatchingWeaponCondition);
...
static function X2AbilityTemplate Overseer()
{
	...
	Effect.DuplicateResponse = eDupe_Ignore;
	Effect.AddShredModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("OVERSEER_SHRED"));
	Effect.AbilityTargetConditions.AddItem(default.GameplayVisibilityCondition);
...
static function X2AbilityTemplate Vigilante()
{
	...
	ADVEffect = new class'XMBEffect_ConditionalBonus';
	ADVEffect.AddPercentDamageModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("VIGILANTE_CRIT_DAMAGE_BONUS"), eHit_Crit);
...
static function X2AbilityTemplate Toxicologist()
{
	...
	Effect.DamageBonus = class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("TOXICOLOGIST_DAMAGE_BONUS");
...
static function X2AbilityTemplate Electrician()
{
	...
	Effect.DamageBonus = class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("ELECTRICIAN_DAMAGE_BONUS");
...
static function X2AbilityTemplate Chemist()
{
	...
	Effect.DamageBonus = class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("CHEMIST_DAMAGE_BONUS");

	// Create an effect that make
	Effect2 = new class'XMBEffect_ConditionalBonus';
	Effect2.EffectName = 'RpgChemist_Bonuses';
	Effect2.AddShredModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("CHEMIST_SHRED_BONUS_CV"), eHit_Success, 'conventional');
	Effect2.AddShredModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("CHEMIST_SHRED_BONUS_MG"), eHit_Success, 'magnetic');
	Effect2.AddShredModifier(class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("CHEMIST_SHRED_BONUS_BM"), eHit_Success, 'beam');
...
static function X2AbilityTemplate Pyromaniac()
{
	...
	Effect.DamageBonus = class'RPGO_Helper'.static.GetAbilityConfig().GetConfigIntValue("PYROMANIAC_DAMAGE_BONUS");
