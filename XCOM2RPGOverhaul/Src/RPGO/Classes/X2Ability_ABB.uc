class X2Ability_ABB extends XMBAbility;
...
static function X2AbilityTemplate DrivenByVengeance()
{
	...
	Effect.AddStatChange(eStat_Will, class'Config_Manager'.static.GetConfigIntValue("DRIVEN_BY_VENGEANCE_WILL"));
	...
	Effect2.AddPersistentStatChange(eStat_Offense, class'Config_Manager'.static.GetConfigIntValue("DRIVEN_BY_VENGEANCE_AIM"));
	Effect2.AddPersistentStatChange(eStat_CritChance, class'Config_Manager'.static.GetConfigIntValue("DRIVEN_BY_VENGEANCE_CRIT"));
